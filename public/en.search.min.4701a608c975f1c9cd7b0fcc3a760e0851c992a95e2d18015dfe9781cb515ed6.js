'use strict';(function(){const searchDataURL='/en.search-data.min.1243fee5d00dfbe37d6868a184c5dd6f9adae87e4c182ed4dce30cd6e7b165cb.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
