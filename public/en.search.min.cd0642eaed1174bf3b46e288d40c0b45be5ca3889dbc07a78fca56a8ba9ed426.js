'use strict';(function(){const searchDataURL='/en.search-data.min.99a45a989c870bdb6235a28fd8b6f2e822cf2b9ab7653aae7afc8cc99de8963f.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
