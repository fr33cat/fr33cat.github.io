'use strict';(function(){const searchDataURL='/en.search-data.min.4006814f468cc87878e5e70e3a0eb86664d6b8166466d446b9fca17f48f96872.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
