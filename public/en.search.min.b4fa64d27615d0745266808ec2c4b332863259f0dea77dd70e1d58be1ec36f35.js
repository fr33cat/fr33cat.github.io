'use strict';(function(){const searchDataURL='/en.search-data.min.758a6879766ed187f69595fb714461ee26a37b4910069a9fed8af65695830fb3.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
