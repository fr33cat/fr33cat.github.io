'use strict';(function(){const searchDataURL='/en.search-data.min.12b9a870cc7565a111194b9d5f5d01e6d073d32d55026e37ec076c872c53eb46.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
