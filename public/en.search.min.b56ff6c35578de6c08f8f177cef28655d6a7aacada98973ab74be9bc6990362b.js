'use strict';(function(){const searchDataURL='/en.search-data.min.6fdc9c71468bebe5ecbb310e12858bdc96882924a8beb0ff99a4e9c2843a86b3.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
