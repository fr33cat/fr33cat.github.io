'use strict';(function(){const searchDataURL='/en.search-data.min.cff0eadc8201d25d9a9ca6637a90392a37b4e87c1cc263bf075d19bd64cac1a8.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
