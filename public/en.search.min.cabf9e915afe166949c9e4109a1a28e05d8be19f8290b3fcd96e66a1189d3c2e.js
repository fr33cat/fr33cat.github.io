'use strict';(function(){const searchDataURL='/en.search-data.min.3419a134c10b01b22d07ade899dd294cfcfa791df79bbaec4dfcd9a13ef3d0c9.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
