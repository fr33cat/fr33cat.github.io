'use strict';(function(){const searchDataURL='/en.search-data.min.7c9a4e3afa1d551d19b2b06f224089d3a43f0c03898f7f4856727def2ab70cc8.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
